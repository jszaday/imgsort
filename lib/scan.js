 ...
 * @property {string[]} explicit - pref keys whose flag appeared in argv (either
 *   side of a pair): 'focusMode', 'singleKeyAdvance', 'noSingleStoreUnchanged',
 *   'keepUncategorized', 'sessionEnabled', 'out'. Scan-only flags (-r,
 *   --follow-symlinks) are not tracked.
 */
